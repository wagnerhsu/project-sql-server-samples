...
2. Upload the script to the shell using the following command:
    ...
    ```console
    curl https://raw.githubusercontent.com/microsoft/sql-server-samples/master/samples/manage/azure-arc-enabled-sql-server/modify-license-type/modify-license-type.ps1 -o migrate-to-azure-arc-data.ps1
    ```
